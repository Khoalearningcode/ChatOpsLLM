...
response_format_map = {
    PromptType.ENHANCE_PROMPT: llmopsOut,
    PromptType.FEW_SHOT_PROMPT: llmopsOut,
    PromptType.CHAIN_OF_THOUGHT_PROMPT: llmopsOut,
    PromptType.STRUCTURE_OUTPUT_PROMPT: llmopsOut,
}
