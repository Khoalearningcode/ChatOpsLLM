...
const llmopsLanding = () => {
  const bgGradient = useColorModeValue(
    "linear(to-br, purple.100, indigo.100)",
    "linear(to-br, purple.200, indigo.200)"
  );
  ...
  return (
    <Box minH="100vh" color={textColor} overflow="hidden">
      <Helmet>
        <title>llmops - Transform Your Prompts</title>
        <meta
          name="description"
          content="llmops helps you transform basic queries into sophisticated prompts for exceptional results with AI language models."
        />
      ...
      <Container maxW="container.xl" py={6} position="relative">
        ...
        <VStack spacing={10} align="center" justify="center" py={20}>
          ...
          >
            ...
            >
              Transform basic queries into sophisticated prompts for exceptional
              results.
            </MotionText>
          </MotionBox>
        ...
        >
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={8}>
            {[
              {
                title: "Intuitive API",
                description: "Easily integrate llmops into your projects.",
              },
              {
                title: "Versatile Techniques",
                description: "Apply a range of prompt engineering strategies.",
              },
              {
                title: "Customizable",
                description:
                  "Tailor the transformation process to your specific needs.",
              },
              {
                title: "Open-source",
                description:
                  "Contribute to the development and benefit from the community.",
              },
            ].map((feature, index) => (
              <MotionBox
                key={index}
        ...
        <Accordion allowMultiple width="100%" maxW="800px" mx="auto" mt={20}>
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              llmops is a tool that helps you transform basic queries into
              sophisticated prompts for better results when working with AI
              language models.
            </AccordionPanel>
          </AccordionItem>
      ...
      <Box py={6} textAlign="center" position="relative">
        <Text>&copy; 2024 llmops. All rights reserved.</Text>
      </Box>
    </Box>
  );
};

export default React.memo(llmopsLanding);
